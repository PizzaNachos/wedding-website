export const en = {
	...
	hero: {
		...
		pleasure: 'Request the pleasure of your company'
	},
	countdown: {
		title: 'Counting Down',
	...
	story: {
		...
		closing: 'And the rest is still being written\u2026',
		entries: [
			{
				date: 'Spring 2023',
				title: 'How We Met',
	...
	faqs: {
		...
		questions: [
			...
			},
			{
				...
				answer:
					'We will miss you! Please update your RSVP using the link from your invitation so we can plan accordingly.'
			}
		]
	},
	lodging: {
	...
	photos: {
		...
		gallery: 'Gallery',
		sharePhotos: 'Share Photos',
		shareTitle: 'Share Your Memories',
		tabs: {
	...
	rsvpForm: {
		child: '(Child)',
		householdContactTitle: 'Contact Information',
		householdContactSubtitle: 'One set of contact info for your household',
		email: 'Email',
